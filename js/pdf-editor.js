...
function syncChrome() {
  ...
  $$(".pdf-tool[data-tool]").forEach((btn) => {
...
function selectAnno(id) {
  state.selectedId = id;
  $$(".pdf-anno").forEach((el) => el.classList.toggle("is-selected", el.dataset.id === id));
  syncChrome();
}
